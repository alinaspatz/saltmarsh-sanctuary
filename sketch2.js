...
function setup() {
  ...
  c.color = color(90, 143, 73);

  // c.color = color(210, 250, 140);
  c.addRule("F", "F[-X][+X]");
  c.addRule("X", "F[-X]F[+F]");
  ...
  d.name = "Sea Lavender";
  d.color = color(90, 143, 73);

  // d.color = color(100, 200, 80);
  ...
  e.color = color(90, 143, 73);

  // e.color = color(219, 255, 205);
