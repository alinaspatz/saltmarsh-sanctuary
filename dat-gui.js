...
dat.GUI = dat.gui.GUI = (function (
  ...
  m.CLASS_DRAG = "drag";
  m.DEFAULT_WIDTH = 245;
  m.TEXT_CLOSED = "Close Menu";
  m.TEXT_OPEN = "Open Menu";
  g.bind(
    window,
    "keydown",
    function (a) {
