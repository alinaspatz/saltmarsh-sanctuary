...
noStroke();
    ...
    //    } }  
        ellipse(0, 0, 1, 12);
        ellipse(0, 0, 13, 1);
rotate(48);        ellipse(0, 0, 12, 1);    ellipse(0, 0, 1, 13);rotate(23); 
     ellipse(0, 0, 1, 12);
        ellipse(0, 0, 13, 1);
rotate(230);        ellipse(0, 0, 12, 1);    ellipse(0, 0, 1, 13);
       // stroke("rgba(228,123,142,.9)");
           stroke("rgb(254,255,212)");
           // stroke("black");
...
//   c.addRule('F', 'FF-[-F+F+F]+[+F-F-F]');
  var c = new LSystem('F', 22.5, 360, .6, 6);
  ...
  // F
  var f = new LSystem('X', .5, 110, 0.44, 6);
            f.name = "Seaside Knotweed";
    // f.color = color("black");
  // f.color = color(90,143,73);
  ...
  var c = gui.add(this, 'Specimen', {'Saltmarsh Loosestrife': 0, 'Sea Blite': 1, 'Saltmarsh Cordgrass': 2, 'Sea Lavender': 3, 'Tufted Hairgrass': 4, 'Seaside Knotweed': 5});
